...
export function AlertsPanel({ selectedOfficer, isAdmin = false }: AlertsPanelProps) {
  ...
  useEffect(() => {
    ...
    setAlerts([...mockAlerts, ...systemAlerts]);
  }, []);
  ...
  const handleGenerateAlerts = () => {
    const systemAlerts = alertService.generateSystemAlerts();
    setAlerts(prev => [...prev.filter(a => !a.autoGenerated), ...systemAlerts]);
    console.log(`Generated ${systemAlerts.length} new system alerts`);
  };
              ...
              <div key={alert.id} className="flex items-start justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex items-start space-x-3 flex-1">
                  <div className="flex flex-col items-center space-y-1">
                    ...
                    {alert.autoGenerated && (
                      <Bot className="h-3 w-3 text-blue-600" title="Auto-generated" />
                    )}
                  </div>
                  <div className="flex-1">
